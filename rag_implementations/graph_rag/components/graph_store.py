...
class GraphStore:
    ...
    def _create_cluster(self):
        ...
        from utils.aws.neptune.vpc import VPCManager  # Import VPCManager
        ...
        # Override VPC settings from instance metadata/default
        self.neptune_manager.vpc_id = vpc_id
        self.neptune_manager.subnet_ids = subnet_ids
        
        print("\nCreating Neptune cluster in validated VPC...")
        self.endpoint = self.neptune_manager.create_cluster(
            subnet_ids=subnet_ids,
            security_group_id=security_group_id
        )
        
        print(f"✅ Neptune cluster created successfully at: {self.endpoint}")
    ...
    def cleanup(self, delete_resources: bool = False):
        ...
        Args:
            delete_resources: Whether to delete Neptune and VPC resources
        """
        if self.graph:
            try:
                self.graph.close()
